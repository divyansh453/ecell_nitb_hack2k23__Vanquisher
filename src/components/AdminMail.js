...
const AdminMail = () => {
    ...
    const submitHandler=(e)=>{
        e.preventDefault();
        axios.post(`https://ecellnitbhack2k23vanquisher-production.up.railway.app/info_student/admin_view_email/${localStorage.getItem("profile_id")}`,{
            email:formvalues.email,
            company:formvalues.company,
            admin:localStorage.getItem("profile_id"),
        }).then((res)=>{
            console.log(res);
        }).catch((err)=>{
            console.log(err);
       ...
       {/* <h2 id="h2">Send Mails Directly to Corporation/Companies</h2> */}
        <div class="loginControls">
            ...
            <form onSubmit={submitHandler} className="loginPage">
                ...
                {/* <input type="email" name="email" value={formvalues.full_name} placeholder="Full Name" onChange={userHandler}/> */}
                ...
                <input type="text" name="company" value={formvalues.company} placeholder="Company" onChange={userHandler}/>
