...
class UserModelAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('full_name','age','isverified','gender','branch')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('roll_number','mobile_number','email', 'full_name','branch','age','gender','isverified', 'password1', 'password2'),
        }),
    )
